...
File: liberty.html
A stark, pulsing text projection asserting the constitutional right to due process under the 14th Amendment.

How to Use
	1.	Open the live site: https://yourusername.github.io/projections
	2.	Tap the projection you want
	3.	Open fullscreen in your browser
	4.	Project
Each file is fully self-contained — no internet connection required once loaded.

FILES:
README.md:  This file
index.html:  Menu links to projections
presidents.html:  Presidents' House projection
liberty.html:  Liberty Bell projection
